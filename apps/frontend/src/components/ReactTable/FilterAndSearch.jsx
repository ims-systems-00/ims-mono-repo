...
const FilterAndSearch = ({
  ...
  return (
    <React.Fragment>
      <Row className="filter-search d-lg-flex justify-around align-items-center my-1">
        ...
        <Col md="6" className="mb-1">
          <div className="d-flex justify-content-lg-start justify-content-md-start action-container">
            {isSearchable && (
              <div className="me-md-3 me-md-3  table-search-container shadow-sm--hover">
            ...
            <div className="d-flex create-filter-wrapper">
              {isFilterable && filterToolbar && (
                <div className="me-md-3 me-md-3 create-filer">
                  {filterToolbar}
                </div>
              )}
            </div>
                ...
                <div className="me-md-3 me-md-3 create-filer">
                  <Dropdown isOpen={sortDropdownOpen} toggle={sortToggle}>
                    <DropdownToggle
                      ...
                      size="md"
                    >
                      <i class="fa-solid fa-sort me-2 me-2 p-0 shadow-sm--hover" />
        ...
        <Col md="6" className="mb-1">
          <div className="d-flex justify-content-lg-end justify-content-md-end action-container">
            {tableToolbar && <div className="create-filer">{tableToolbar}</div>}
            {hasBulkActions && (
              <>
