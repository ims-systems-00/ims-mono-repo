...
const HardwareFilter = () => {
  let { processing, modalFilter, toggleModalFilter, HardwareQueryTools } =
    useHardwareAssets();
  const dataSet = {
    data: {
      groups: [],
  ...
  return (
    <React.Fragment>
      ...
      <Modal
        ...
        style={{ width: "600px" }}
        backdrop={processing[USER_ACTIONS.LOAD_HARDWARES].status ? false : true}
      >
                ...
                <Row>
                  ...
                  >
                    ...
                    <Button
                      ...
                      className="shadow-sm--hover"
                      onClick={() => {
                        HardwareQueryTools?.handleFilter({
                          value: {
                            group: {
