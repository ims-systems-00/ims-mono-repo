...
const PeopleFilter = () => {
  let { processing, modalFilter, toggleModalFilter, PeopleQueryTools } =
    usePeopleAssets();
  const dataSet = {
    data: {
      groups: [],
  ...
  return (
    <React.Fragment>
      ...
      <Modal
        ...
        style={{ width: "600px" }}
        backdrop={processing[USER_ACTIONS.LOAD_PEOPLES].status ? false : true}
      >
