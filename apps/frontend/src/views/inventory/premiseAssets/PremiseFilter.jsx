...
const PremiseFilter = () => {
  let { processing, modalFilter, toggleModalFilter, PremiseQueryTools } =
    usePremiseAssets();
  const dataSet = {
    data: {
      groups: [],
  ...
  return (
    <React.Fragment>
      ...
      <Modal
        ...
        style={{ width: "600px" }}
        backdrop={processing[USER_ACTIONS.LOAD_PREMISES].status ? false : true}
      >
                ...
                <Row>
                  ...
                  >
                    ...
                    <Button
                      ...
                      className="shadow-sm--hover"
                      onClick={() => {
                        PremiseQueryTools?.handleFilter({
                          value: {
                            group: {
