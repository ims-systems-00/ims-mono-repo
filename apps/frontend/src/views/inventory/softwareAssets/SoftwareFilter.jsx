...
const SoftwareFilter = () => {
  let { processing, modalFilter, toggleModalFilter, SoftwareQueryTools } =
    useSoftwareAssets();
  const dataSet = {
    data: {
      groups: [],
  ...
  return (
    <React.Fragment>
      ...
      <Modal
        ...
        style={{ width: "600px" }}
        backdrop={processing[USER_ACTIONS.LOAD_SOFTWARES].status ? false : true}
      >
                ...
                <Row>
                  ...
                  >
                    ...
                    <Button
                      ...
                      className="shadow-sm--hover"
                      onClick={() => {
                        SoftwareQueryTools?.handleFilter({
                          value: {
                            group: {
