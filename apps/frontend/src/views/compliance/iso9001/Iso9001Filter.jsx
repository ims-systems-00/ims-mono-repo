...
import filters from "./iso9001Sections";
import USER_ACTIONS from "./actions";

const Iso9001Filter = ({}) => {
  let { processing, modalFilter, toggleModalFilter, Iso9001QueryTools } =
    useISO9001();
  const dataSet = {
    data: {
      status: [],
  ...
  return (
    <React.Fragment>
      ...
      <Modal
        ...
        style={{ width: "600px" }}
        backdrop={
          processing[USER_ACTIONS.LOAD_COMPLIANCE_9001].status ? false : true
        }
      >
        ...
        <ModalBody>
          <Form action="/" className="form-horizontal" method="get">
            <p>Filter ISO 9001 to get specific data</p>
            <Row className="mt-3">
              <Col md={"12"}>
                <ImsInputSelect
                  label={"Status"}
                ...
                <Row>
                  ...
                  >
                    ...
                    <Button
                      ...
                      className="shadow-sm--hover"
                      onClick={() => {
                        Iso9001QueryTools?.handleFilter({
                          value: {
