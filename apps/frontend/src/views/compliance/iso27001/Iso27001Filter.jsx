...
import filters from "./iso27001Sections";
import { useISO27001 } from "./store";
import USER_ACTIONS from "./actions";

const Iso27001Filter = ({}) => {
  let { processing, modalFilter, toggleModalFilter, Iso27001QueryTools } =
    useISO27001();
  const dataSet = {
    data: {
      status: [],
      ...
      >
        ...
        <ModalBody>
          <Form action="/" className="form-horizontal" method="get">
            <p>Filter ISO 27001 to get specific data</p>
            <Row className="mt-3">
              <Col md={"12"}>
                <ImsInputSelect
                  label={"Status"}
                ...
                <Row>
                  ...
                  >
                    ...
                    <Button
                      ...
                      className="shadow-sm--hover"
                      onClick={() => {
                        Iso27001QueryTools?.handleFilter({
                          value: {
