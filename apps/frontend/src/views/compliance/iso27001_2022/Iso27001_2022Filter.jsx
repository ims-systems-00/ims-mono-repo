...
import filters from "./iso27001_2022Sections";
import { useISO27001_2022 } from "./store";
import USER_ACTIONS from "./actions";

const Iso27001_2022Filter = ({}) => {
  let { processing, modalFilter, toggleModalFilter, Iso27001_2022QueryTools } =
    useISO27001_2022();
  const dataSet = {
    data: {
      status: [],
  ...
  return (
    <>
      ...
      <Modal
        ...
        style={{ width: "600px" }}
        backdrop={
          processing[USER_ACTIONS.LOAD_COMPLIANCE_27001_2022].status
            ? false
            : true
        }
      >
        ...
        <ModalBody>
          <Form action="/" className="form-horizontal" method="get">
            <p>Filter ISO 27001_2022 to get specific data</p>
            <Row className="mt-3">
              <Col md={"12"}>
                <ImsInputSelect
                  label={"Status"}
                ...
                <Row>
                  ...
                  >
                    ...
                    <Button
                      ...
                      className="shadow-sm--hover"
                      onClick={() => {
                        Iso27001_2022QueryTools?.handleFilter({
                          value: {
...
export default Iso27001_2022Filter;
