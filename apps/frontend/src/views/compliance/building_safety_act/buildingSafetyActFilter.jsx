...
import filters from "./buildingSafetyActSections";
import USER_ACTIONS from "./actions";
import useBuildingSafetyAct from "./store/useBuildingSafetyAct";

const BuildingSafetyActFilter = ({}) => {
  let { processing, modalFilter, toggleModalFilter, buildingSafetyActQueryTools } =
  ...
  return (
    <>
      ...
      >
        <i class="ims-icons icon-icon-funnelsimple-24 me-1" />
        Filter
      </Button>
      <Modal
        isOpen={modalFilter}
        ...
        style={{ width: "600px" }}
        backdrop={
          processing[USER_ACTIONS.LOAD_COMPLIANCE].status ? false : true
        }
      >
        ...
        <ModalBody>
          <Form action="/" className="form-horizontal" method="get">
            <p>Filter Building Safety Act to get specific data</p>
            <Row className="mt-3">
              <Col md={"12"}>
                <ImsInputSelect
                  label={"Status"}
                ...
                <Row>
                  ...
                  >
                    ...
                    <Button
                      ...
                      className="shadow-sm--hover"
                      onClick={() => {
                        buildingSafetyActQueryTools?.handleFilter({
                          value: {
...
export default BuildingSafetyActFilter;