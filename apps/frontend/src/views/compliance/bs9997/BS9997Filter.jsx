...
import filters from "./bs9997sections";

const BS9997Filter = ({}) => {
  let { modalFilter, toggleModalFilter, BS9997QueryTools } = useBS9997();
  const dataSet = {
    data: {
      status: [],
      selectedStatus: "",
      ...
      >
        ...
        <ModalBody>
          <Form action="/" className="form-horizontal" method="get">
            <p>Filter BS9997 to get specific data</p>
            <Row className="mt-3">
              <Col md={"12"}>
                <ImsInputSelect
                  label={"Status"}
