...
import filters from "./iso15686Sections";
import USER_ACTIONS from "./actions";

const Iso15686Filter = ({}) => {
  let { processing, modalFilter, toggleModalFilter, Iso15686QueryTools } =
    useISO15686();
  const dataSet = {
    data: {
      status: [],
  ...
  return (
    <>
      ...
      <Modal
        ...
        style={{ width: "600px" }}
        backdrop={
          processing[USER_ACTIONS.LOAD_COMPLIANCE_15686].status ? false : true
        }
      >
        ...
        <ModalBody>
          <Form action="/" className="form-horizontal" method="get">
            <p>Filter ISO 15686 to get specific data</p>
            <Row className="mt-3">
              <Col md={"12"}>
                <ImsInputSelect
                  label={"Status"}
                ...
                <Row>
                  ...
                  >
                    ...
                    <Button
                      ...
                      className="shadow-sm--hover"
                      onClick={() => {
                        Iso15686QueryTools?.handleFilter({
                          value: {
