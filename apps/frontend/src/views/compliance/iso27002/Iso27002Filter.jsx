...
import filters from "./iso27002Sections";
import { useISO27002 } from "./store";
import USER_ACTIONS from "./actions";

const Iso27002Filter = ({}) => {
  let { processing, modalFilter, toggleModalFilter, Iso27002QueryTools } =
    useISO27002();
  const dataSet = {
    data: {
      status: [],
  ...
  return (
    <>
      ...
      <Modal
        ...
        style={{ width: "600px" }}
        backdrop={
          processing[USER_ACTIONS.LOAD_COMPLIANCE_27002].status ? false : true
        }
      >
        ...
        <ModalBody>
          <Form action="/" className="form-horizontal" method="get">
            <p>Filter ISO 27002 to get specific data</p>
            <Row className="mt-3">
              <Col md={"12"}>
                <ImsInputSelect
                  label={"Status"}
                ...
                <Row>
                  ...
                  >
                    ...
                    <Button
                      ...
                      className="shadow-sm--hover"
                      onClick={() => {
                        Iso27002QueryTools?.handleFilter({
                          value: {
