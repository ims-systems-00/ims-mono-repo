...
import filters from "./iso27001_2022AnnexASections";
import { useISO27001_Annex_A } from "./store";
import USER_ACTIONS from "./actions";

const Iso27001_2022AnnexAFilter = ({}) => {
  let {
    processing,
    modalFilter,
    toggleModalFilter,
  ...
  return (
    <>
      ...
      <Modal
        ...
        style={{ width: "600px" }}
        backdrop={
          processing[USER_ACTIONS.LOAD_COMPLIANCE_27001_ANNEX_A].status
            ? false
            : true
        }
      >
        ...
        <ModalBody>
          <Form action="/" className="form-horizontal" method="get">
            <p>Filter ISO 27001_2022AnnexA to get specific data</p>
            <Row className="mt-3">
              <Col md={"12"}>
                <ImsInputSelect
                  label={"Status"}
                ...
                <Row>
                  ...
                  >
                    ...
                    <Button
                      ...
                      className="shadow-sm--hover"
                      onClick={() => {
                        Iso27001_Annex_AQueryTools?.handleFilter({
                          value: {
...
export default Iso27001_2022AnnexAFilter;
