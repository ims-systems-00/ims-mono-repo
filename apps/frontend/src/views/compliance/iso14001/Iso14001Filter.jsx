...
import filters from "./iso14001Sections";
import { useISO14001 } from "./store";
import USER_ACTIONS from "./actions";

const Iso14001Filter = ({}) => {
  let { processing, modalFilter, toggleModalFilter, Iso14001QueryTools } =
    useISO14001();
  const dataSet = {
    data: {
      status: [],
  ...
  return (
    <>
      ...
      <Modal
        ...
        style={{ width: "600px" }}
        backdrop={
          processing[USER_ACTIONS.LOAD_COMPLIANCE_14001].status ? false : true
        }
      >
        ...
        <ModalBody>
          <Form action="/" className="form-horizontal" method="get">
            <p>Filter ISO 14001 to get specific data</p>
            <Row className="mt-3">
              <Col md={"12"}>
                <ImsInputSelect
                  label={"Status"}
                ...
                <Row>
                  ...
                  >
                    ...
                    <Button
                      ...
                      className="shadow-sm--hover"
                      onClick={() => {
                        Iso14001QueryTools?.handleFilter({
                          value: {
