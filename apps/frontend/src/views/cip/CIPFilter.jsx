...
const CIPFilter = () => {
  let { processing, modalFilter, toggleModalFilter, CIPQueryTools } = useCip();
  const dataSet = {
    data: {
      status: [],
      groups: [],
  ...
  return (
    <React.Fragment>
      ...
      <Modal
        ...
        style={{ width: "600px" }}
        backdrop={processing[USER_ACTIONS.LOAD_CIPS].status ? false : true}
      >
        ...
        <ModalBody>
          <Form action="/" className="form-horizontal" method="get">
            <p>Filter ofi to get specific data</p>
            <Row className="mt-3">
              <Col md={"12"}>
                <ImsInputSelect
                  label={"Status"}
