    ...
    steps: [
      {
        ...
        content: "Click Audits and select External.",
        placement: "right",
      ...
      },
      {
        ...
        content: "Click “Schedule” to schedule an external audit.",
        placement: "right",
        spotlightClicks: true,
        disableBeacon: true,
        disableOverlayClose: true,
...

      {
        ...
        content: "Click “action” to view the details of the external audit.",
        disableBeacon: true,
        placement: "bottom",
        spotlightClicks: true,
      },
