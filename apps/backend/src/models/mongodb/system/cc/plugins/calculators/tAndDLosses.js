  ...
  try {
    if (
      ...
      let defraFactor = await CCFactors.findOne({
        ...
        combinedActivityReference: "T&D- UK electricity, Electricity: UK",
        uom: this.unit,
      ...
      if (
        ...
        this.tAndDLosses = (this.amount * factor) / 1000;
      }
      if (
      ...
      this.tAndDLosses = this.tAndDLosses.toFixed(5);
    }
  } catch (err) {
    logger.error("t and d losses calculation error: ", err);
  }
}
/**
