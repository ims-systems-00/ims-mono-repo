  ...
  try {
    if (
      ...
      let defraFactor = await CCFactors.findOne({
        ...
        combinedActivityReference: "UK electricity (T&D), Electricity: UK",
        uom: this.unit,
      ...
      if (
        ...
        this.wttTandD = (this.amount * factor) / 1000;
      }
      if (
      ...
      this.wttTandD = this.wttTandD.toFixed(5);
    }
  } catch (err) {
    logger.error("wtt t and d calculation error: ", err);
  }
}
/**
