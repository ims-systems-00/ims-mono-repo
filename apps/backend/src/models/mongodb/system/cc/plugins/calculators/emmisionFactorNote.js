...
async function calc() {
  ...
  try {
    ...
    if (
      ...
      this.emmisionFactorNote = customFactor["sourceNotes"];
    }
    if (
      [
        CC_EMISSION_CATEGORY_NAMES.COMPANY_PREMISES,
      ...
      this.emmisionFactorNote = defraFactor ? defraFactor["sourceNotes"] : "";
    }
    ...
    if (
      ...
      this.emmisionFactorNote = sicFactor["sourceNotes"];
    }
    if (
      [
        CC_EMISSION_CATEGORY_NAMES.PURCHASED_GOODS_AND_SERVICES,
    ...
    logger.error("emission factor notes calculation error: ", err);
  }
}
/**
