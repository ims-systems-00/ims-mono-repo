...
<html lang="en">
   <head>
      ...
      <title>${data.organizationId.name} iMS report</title>
                     ...
                     <td valign="top" style="padding: 0px 0px 0px 0px;">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border:0;border-collapse: collapse;border-spacing: 0;width: 100%;background-image: url(https://imssystems.tech/static/assets/images/hero.png);background-size: cover;background-repeat: no-repeat;">
                           <tr>
                              ...
                              <h1 style="font-family: 'Poppins', sans-serif;font-size: 30px;font-weight: bold;line-height: 1.2;color: #fff;">${data.organizationId.name} iMS report</h1>
                              </td>
                           </tr>
                        </table>
                     </td>
                              ...
                              <tr>
                                 <td style="padding: 15px 0 0 16px;font-family: 'Poppins', sans-serif; font-size: 14px;line-height: 1.43;letter-spacing: 0.3px;color: #808396;">
                                    <ul style="margin: 0;padding: 0;">
                                       <li style="margin: 6px 0 0 0;padding: 0;list-style-position: inside;font-weight: 600;font-stretch: normal;font-style: normal;line-height: 1.57;letter-spacing: 0.3px;color: #1c2745;font-size: 14px;font-family: 'Poppins', sans-serif;">Business functions ${data.businessFunctions}</li>
                                       ...
                                       <li style="margin: 6px 0 0 0;padding: 0;list-style-position: inside;font-weight: 600;font-stretch: normal;font-style: normal;line-height: 1.57;letter-spacing: 0.3px;color: #1c2745;font-size: 14px;font-family: 'Poppins', sans-serif;">Compliance functions ${data.complianceFunctions}</li>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border:0;border-collapse: collapse;border-spacing: 0;width: 100%;">
                           ...
                           <tbody>
                              <tr>
                                 <td style="padding: 15px 0 0 16px;font-family: 'Poppins', sans-serif; font-size: 14px;line-height: 1.43;letter-spacing: 0.3px;color: #808396;">
                                    <ul style="margin: 0;padding: 0;">
                                    ${data.risksByStatus.closed.risks.map((risk, index) => `
                                        <li style="margin: 6px 0 0 0;padding: 0;list-style-position: inside;font-weight: 600;font-stretch: normal;font-style: normal;line-height: 1.57;letter-spacing: 0.3px;color: #1c2745;font-size: 14px;font-family: 'Poppins', sans-serif;">${data.risksByStatus.closed.months[index]} ${risk}</li>
                                    `).join('')}
                                    </ul>
                                 </td>
                              </tr>
                  ...
                  <tr>
                     <td valign="top" style="padding: 0;margin: 0;">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border:0;border-collapse: collapse;border-spacing: 0;width: 100%;">
                           <thead>
                              <tr>
                                 <th width="100%" align="left" style="margin: 0;font-family: 'Poppins', sans-serif;padding: 16px 16px 16px 16px;border-radius: 3px;background-color: #e3f1f9;font-size: 16px;font-weight: 600;font-stretch: normal;font-style: normal;line-height: 1.38;letter-spacing: 0.34px;color: #16a4fa;">Business function with most risks</th>
                              </tr>
                           </thead>
                           <tbody>
                              <tr>
                                 <td style="padding: 15px 0 0 16px;font-family: 'Poppins', sans-serif; font-size: 14px;line-height: 1.43;letter-spacing: 0.3px;color: #808396;">
                                    <ul style="margin: 0;padding: 0;">
                                    ${data.businessFunctionsHavingMostRisks.risks.map((risk, index) => `
                                        <li style="margin: 6px 0 0 0;padding: 0;list-style-position: inside;font-weight: 600;font-stretch: normal;font-style: normal;line-height: 1.57;letter-spacing: 0.3px;color: #1c2745;font-size: 14px;font-family: 'Poppins', sans-serif;">${data.businessFunctionsHavingMostRisks.businessFunctionNames[index]} ${risk}</li>
                                    `).join('')}
                                    </ul>
                                 </td>
                              </tr>
                     ...
                     <td valign="top" style="padding: 0;margin: 0;">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border:0;border-collapse: collapse;border-spacing: 0;width: 100%;">
                           ...
                           <tbody>
                              <tr>
                                 <td style="padding: 15px 0 0 16px;font-family: 'Poppins', sans-serif; font-size: 14px;line-height: 1.43;letter-spacing: 0.3px;color: #808396;">
                                    <p style="font-size: 16px;font-weight: 500;font-stretch: normal;line-height: normal;letter-spacing: 0.34px;color: #808396;font-family: 'Poppins', sans-serif;margin: 0px 0px 12px 0px;">Business functions with most non conformities</p>

                                    <ul style="margin: 0;padding: 0;">
                                    ${data.nonConformities.businessFunctionNames.map((name, index) => `
                                        <li style="margin: 6px 0 0 0;padding: 0;list-style-position: inside;font-weight: 600;font-stretch: normal;font-style: normal;line-height: 1.57;letter-spacing: 0.3px;color: #1c2745;font-size: 14px;font-family: 'Poppins', sans-serif;">${name} ${data.nonConformities.amount[index]}</li>
                                    `).join('')}
                                    </ul>
                                 </td>
                              </tr>
                           ...
                           <tbody>
                              <tr>
                                 <td style="padding: 15px 0 0 16px;font-family: 'Poppins', sans-serif; font-size: 14px;line-height: 1.43;letter-spacing: 0.3px;color: #808396;">
                                    ...
                                    <ul style="margin: 0;padding: 0;">
                                    ${data.businessFunctionsWithMostIncidents.businessFunctionNames.map((name, index) => `
                                        <li style="margin: 6px 0 0 0;padding: 0;list-style-position: inside;font-weight: 600;font-stretch: normal;font-style: normal;line-height: 1.57;letter-spacing: 0.3px;color: #1c2745;font-size: 14px;font-family: 'Poppins', sans-serif;">${name} : raised  ${data.businessFunctionsWithMostIncidents.total[index]}, resolved ${data.businessFunctionsWithMostIncidents.resolved[index]}</li>
                                    `).join('')}
                                    </ul>
                                 </td>
                              </tr>
                           ...
                           <tbody>
                              <tr>
                                 <td style="padding: 15px 0 0 16px;font-family: 'Poppins', sans-serif; font-size: 14px;line-height: 1.43;letter-spacing: 0.3px;color: #808396;">
                                    ...
                                    <p style="font-size: 16px;font-weight: 500;font-stretch: normal;line-height: normal;letter-spacing: 0.34px;color: #808396;font-family: 'Poppins', sans-serif;margin: 0px 0px 12px 0px;">Business functions with most OFIs</p>

                                    <ul style="margin: 0;padding: 0;">
                                    ${data.businessFunctionsWithMostOpportunities.businessFunctionNames.map((name, index) => `
                                        <li style="margin: 6px 0 0 0;padding: 0;list-style-position: inside;font-weight: 600;font-stretch: normal;font-style: normal;line-height: 1.57;letter-spacing: 0.3px;color: #1c2745;font-size: 14px;font-family: 'Poppins', sans-serif;"> ${name} ${data.businessFunctionsWithMostOpportunities.amount[index]}</li>
                                    `).join('')}
                                    </ul>
                                 </td>
                              </tr>
                     ...
                     <td valign="top" style="padding: 0;margin: 0;">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border:0;border-collapse: collapse;border-spacing: 0;width: 100%;">
                           <tbody>
                              <tr>
                                 <td style="padding: 0px 0 0 16px;font-family: 'Poppins', sans-serif; font-size: 14px;line-height: 1.43;letter-spacing: 0.3px;color: #808396;">
                                    <p style="font-size: 16px;font-weight: 500;font-stretch: normal;line-height: normal;letter-spacing: 0.34px;color: #808396;font-family: 'Poppins', sans-serif;margin: 0px 0px 12px 0px;">Business functions with most OFIs implemented</p>

                                    <ul style="margin: 0;padding: 0;">
                                    ${data.businessFunctionsWithMostImprovements.businessFunctionNames.map((name, index) => `
                                        <li style="margin: 6px 0 0 0;padding: 0;list-style-position: inside;font-weight: 600;font-stretch: normal;font-style: normal;line-height: 1.57;letter-spacing: 0.3px;color: #1c2745;font-size: 14px;font-family: 'Poppins', sans-serif;"> ${name} ${data.businessFunctionsWithMostImprovements.amount[index]}</li>
                                    `).join('')}
                                    </ul>
                                 </td>
                              </tr>
                  ...
                  <tr>
                     <td valign="top" style="padding: 0;margin: 0;">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border:0;border-collapse: collapse;border-spacing: 0;width: 100%;">
                           <thead>
                              <tr>
                                 <th width="100%" align="left" style="margin: 0;font-family: 'Poppins', sans-serif;padding: 16px 16px 16px 16px;border-radius: 3px;background-color: #e3f1f9;font-size: 16px;font-weight: 600;font-stretch: normal;font-style: normal;line-height: 1.38;letter-spacing: 0.34px;color: #16a4fa;">Compliance</th>
                              </tr>
                           </thead>
                           <tbody>
                              <tr>
                                 <td style="padding: 15px 0 0 16px;font-family: 'Poppins', sans-serif; font-size: 14px;line-height: 1.43;letter-spacing: 0.3px;color: #808396;">
                                    <ul style="margin: 0;padding: 0;">
                                    ${Object.keys(data.compliance).map((name, i) => i > 0 && data.compliance[name] ? `
                                        <li style="margin: 6px 0 0 0;padding: 0;list-style-position: inside;font-weight: 600;font-stretch: normal;font-style: normal;line-height: 1.57;letter-spacing: 0.3px;color: #1c2745;font-size: 14px;font-family: 'Poppins', sans-serif;">${name.toUpperCase()} ${data.compliance[name]}%</li>
                                    `: '').join('')}
                                    </ul>
                                 </td>
                              </tr>
                  ...
                  <tr>
                     <td valign="top" style="padding: 0;margin: 0;">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border:0;border-collapse: collapse;border-spacing: 0;width: 100%;">
                           <thead>
                              <tr>
                                 <th width="100%" align="left" style="margin: 0;font-family: 'Poppins', sans-serif;padding: 16px 16px 16px 16px;border-radius: 3px;background-color: #e3f1f9;font-size: 16px;font-weight: 600;font-stretch: normal;font-style: normal;line-height: 1.38;letter-spacing: 0.34px;color: #16a4fa;">CQC compliance</th>
                              </tr>
                           </thead>
                           <tbody>
                              <tr>
                                 <td style="padding: 15px 0 0 16px;font-family: 'Poppins', sans-serif; font-size: 14px;line-height: 1.43;letter-spacing: 0.3px;color: #808396;">
                                    <ul style="margin: 0;padding: 0;">
                                       ${data.cqc.compliance.overall.map(compliance => `
                                          <li style="margin: 6px 0 0 0;padding: 0;list-style-position: inside;font-weight: 600;font-stretch: normal;font-style: normal;line-height: 1.57;letter-spacing: 0.3px;color: #1c2745;font-size: 14px;font-family: 'Poppins', sans-serif;">${compliance.siteName.fullName} ${compliance.percentage}% ${compliance.rating}</li>
                                       `).join('')}
                                    </ul>
                                 </td>
                              </tr>
                  ...
                  <tr>
                     <td valign="top" style="padding: 0;margin: 0;">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border:0;border-collapse: collapse;border-spacing: 0;width: 100%;">
                           <thead>
                              <tr>
                                 <th width="100%" align="left" style="margin: 0;font-family: 'Poppins', sans-serif;padding: 16px 16px 16px 16px;border-radius: 3px;background-color: #e3f1f9;font-size: 16px;font-weight: 600;font-stretch: normal;font-style: normal;line-height: 1.38;letter-spacing: 0.34px;color: #16a4fa;">Complaints</th>
                              </tr>
                           </thead>
                           <tbody>
                              <tr>
                                 <td style="padding: 15px 0 0 16px;font-family: 'Poppins', sans-serif; font-size: 14px;line-height: 1.43;letter-spacing: 0.3px;color: #808396;">
                                    <ul style="margin: 0;padding: 0;">
                                    ${data.cqc.complaints.businessFunctionNames.map((businessFunction, index) => `
                                       <li style="margin: 6px 0 0 0;padding: 0;list-style-position: inside;font-weight: 600;font-stretch: normal;font-style: normal;line-height: 1.57;letter-spacing: 0.3px;color: #1c2745;font-size: 14px;font-family: 'Poppins', sans-serif;">${businessFunction.fullName} Open ${data.cqc.complaints.total[index]} Closed  ${data.cqc.complaints.signedOff[index]}</li>
                                    `).join('')}
                                    </ul>
                                 </td>
                              </tr>
                  ...
                  <tr>
                     <td valign="top" style="padding: 0;margin: 0;">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border:0;border-collapse: collapse;border-spacing: 0;width: 100%;">
                           <thead>
                              <tr>
                                 <th width="100%" align="left" style="margin: 0;font-family: 'Poppins', sans-serif;padding: 16px 16px 16px 16px;border-radius: 3px;background-color: #e3f1f9;font-size: 16px;font-weight: 600;font-stretch: normal;font-style: normal;line-height: 1.38;letter-spacing: 0.34px;color: #16a4fa;">Whistleblowing</th>
                              </tr>
                           </thead>
                           <tbody>
                              <tr>
                                 <td style="padding: 15px 0 0 16px;font-family: 'Poppins', sans-serif; font-size: 14px;line-height: 1.43;letter-spacing: 0.3px;color: #808396;">
                                    <ul style="margin: 0;padding: 0;">
                                    ${data.cqc.whistleBlows.businessFunctionNames.map((businessFunction, index) => `
                                        <li style="margin: 6px 0 0 0;padding: 0;list-style-position: inside;font-weight: 600;font-stretch: normal;font-style: normal;line-height: 1.57;letter-spacing: 0.3px;color: #1c2745;font-size: 14px;font-family: 'Poppins', sans-serif;">${businessFunction.fullName} Open ${data.cqc.whistleBlows.total[index]} Closed  ${data.cqc.whistleBlows.signedOff[index]}</li>
                                    `).join('')}
                                    </ul>
                                 </td>
                              </tr>
                  ...
                  <tr>
                     <td valign="top" style="padding: 0;margin: 0;">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border:0;border-collapse: collapse;border-spacing: 0;width: 100%;">
                           <thead>
                              <tr>
                                 <th width="100%" align="left" style="margin: 0;font-family: 'Poppins', sans-serif;padding: 16px 16px 16px 16px;border-radius: 3px;background-color: #e3f1f9;font-size: 16px;font-weight: 600;font-stretch: normal;font-style: normal;line-height: 1.38;letter-spacing: 0.34px;color: #16a4fa;">Safeguarding</th>
                              </tr>
                           </thead>
                           <tbody>
                              <tr>
                                 <td style="padding: 15px 0 0 16px;font-family: 'Poppins', sans-serif; font-size: 14px;line-height: 1.43;letter-spacing: 0.3px;color: #808396;">
                                    <ul style="margin: 0;padding: 0;">
                                    ${data.cqc.significantEvents.businessFunctionNames.map((businessFunction, index) => `
                                       <li style="margin: 6px 0 0 0;padding: 0;list-style-position: inside;font-weight: 600;font-stretch: normal;font-style: normal;line-height: 1.57;letter-spacing: 0.3px;color: #1c2745;font-size: 14px;font-family: 'Poppins', sans-serif;">${businessFunction.fullName} Open ${data.cqc.significantEvents.total[index]} Closed  ${data.cqc.significantEvents.signedOff[index]}</li>
                                    `).join('')}
                                    </ul>
                                 </td>
                              </tr>
                  ...
                  <tr>
                     <td valign="top" style="padding: 0;margin: 0;">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border:0;border-collapse: collapse;border-spacing: 0;width: 100%;">
                           <thead>
                              <tr>
                                 <th width="100%" align="left" style="margin: 0;font-family: 'Poppins', sans-serif;padding: 16px 16px 16px 16px;border-radius: 3px;background-color: #e3f1f9;font-size: 16px;font-weight: 600;font-stretch: normal;font-style: normal;line-height: 1.38;letter-spacing: 0.34px;color: #16a4fa;">Significant events</th>
                              </tr>
                           </thead>
                           <tbody>
                              <tr>
                                 <td style="padding: 15px 0 0 16px;font-family: 'Poppins', sans-serif; font-size: 14px;line-height: 1.43;letter-spacing: 0.3px;color: #808396;">
                                    <ul style="margin: 0;padding: 0;">
                                    ${data.cqc.safeGuardings.businessFunctionNames.map((businessFunction, index) => `
                                        <li style="margin: 6px 0 0 0;padding: 0;list-style-position: inside;font-weight: 600;font-stretch: normal;font-style: normal;line-height: 1.57;letter-spacing: 0.3px;color: #1c2745;font-size: 14px;font-family: 'Poppins', sans-serif;">${businessFunction.fullName} Open ${data.cqc.safeGuardings.total[index]} Closed  ${data.cqc.safeGuardings.signedOff[index]}</li>
                                    `).join('')}
                                    </ul>
                                 </td>
                              </tr>
